...
//повертає інформацію загального виду 
...
//овертає імена студентів у алфавітному порядку.
...
//повертає обє'кт, в якому ключі це букви у слові
...
let newText =substitute.toLowerCase().split('')
   ...
   console.log(calculateWordLetters ("What is your name fraer"))