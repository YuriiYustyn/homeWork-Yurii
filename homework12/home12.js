      ...
      .then(res => {
         ...
         characters.map(e => axios.get(e)
            .then(res => {
               ...
               if (res.data.gender === "n/a" || res.data.gender === "none" || res.data.gender === "hermaphrodite") {
                  genderCell.innerHTML = `<img src="fa/trans.png" height="50px">`;
               }
               else {
                  genderCell.innerHTML = `<img src="fa/${res.data.gender}.png" height="50px">`;
               }
...
console.log("HHHHEEEELLLO")
document.querySelector('#show-people').addEventListener('submit', (e) => {
   e.preventDefault();
   getInfo(document.querySelector('#film').value);
})
